...
import { CompanyMemberModel as ClassModel } from '../models/companyMemberModel.class.js';
import { BaseController } from './baseController.class.js';

export class CompanyMemberController extends BaseController {
    static table = 'company_members';

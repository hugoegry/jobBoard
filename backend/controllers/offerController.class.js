...
import { OfferModel as ClassModel } from "../models/offerModel.class.js";
import { BaseController } from "./baseController.class.js";

export class OfferController extends BaseController {
  static table = "offers";
  static tableView = "v_offers_with_company";
  static SecondTableView = "offers_with_applications";
  static tableColumns = ClassModel.getColumns(this.table);
  static tableColumnsView = ClassModel.getColumns(this.tableView); // anomalie view et table normal \\
  static tableSecondColumnsView = ClassModel.getColumns(this.SecondTableView);
